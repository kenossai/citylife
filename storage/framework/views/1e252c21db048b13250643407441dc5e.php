            ...
            <div class="row gutter-y-30">
                <div class="col-md-12 col-xl-4 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                    <div class="footer-widget footer-widget--about">
                        <a href="<?php echo e(route('home')); ?>" class="footer-widget__logo">
                            <img src="<?php echo e(asset('assets/images/logo.png')); ?>" width="100" alt="City Life Church">
                        </a>
                ...
                <div class="col-md-3 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="400ms">
                    <div class="footer-widget footer-widget--links">
                        ...
                        <ul class="list-unstyled footer-widget__links">
                            ...
                            <li><a href="<?php echo e(route('media.index')); ?>">Media</a></li>
...
<?php /**PATH C:\Users\kenos\Documents\Github\citylife\resources\views/components/footer.blade.php ENDPATH**/ ?>