<aside class="sidebar-one">
        ...
        <div class="sidebar-one__content">
            ...
            <div class="sidebar-one__logo sidebar-one__item">
                <a href="<?php echo e(route('home')); ?>" aria-label="logo image"><img src="<?php echo e(asset('assets/images/logo-light.png')); ?>" width="155" alt="CityLife Church Logo" /></a>
                ...
                <ul class="sidebar-one__information__list">
                    <li>
                        ...
                        <address class="sidebar-one__information__address">
                            <p class="sidebar-one__information__text">1 South Parade Sheffield S3 8SS, United Kingdom</p>
                        </address>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <p class="sidebar-one__information__text"><a href="tel:+441142728243">0114 272 8243</a></p>
                    </li>
                </ul>
            </div><!-- /.sidebar-one__information -->
            <div class="sidebar-one__socila social-link sidebar-one__item">
                <a href="https://www.facebook.com/drjimaster" aria-label="Facebook">
                    <i class="fab fa-facebook-f" aria-hidden="true"></i>
                    <span class="sr-only">Facebook</span>
                </a>
                <a href="https://www.youtube.com/channel/UCTP2_DfFmZfg5ooFu6alMvA" aria-label="YouTube">
...
<?php /**PATH C:\Users\kenos\Documents\Github\citylife\resources\views/components/sidebar.blade.php ENDPATH**/ ?>