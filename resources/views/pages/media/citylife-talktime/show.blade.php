...
<section class="page-header">
    <div class="page-header__bg" style="background-image: url('{{ $talkTime->image ? asset('storage/' . $talkTime->image) : asset('assets/images/backgrounds/worship-banner-1.jpg') }}');"></div>
    <div class="container">
                                ...
                                @if(str_contains($talkTime->video_url, 'youtube.com') || str_contains($talkTime->video_url, 'youtu.be'))
                                    ...
                                    @else
                                        <div class="position-relative">
                                            <img src="{{ $talkTime->image ? asset('storage/' . $talkTime->image) : asset('assets/images/defaults/talktime-default.jpg') }}" alt="{{ $talkTime->title }}">
                                            <div class="position-absolute top-50 start-50 translate-middle">
                                                <a href="{{ $talkTime->video_url }}" target="_blank" class="cleenhearts-btn cleenhearts-btn--base">
                                    ...
                                    @foreach($relatedTalkTimes as $related)
                                        <li class="sidebar__posts__item">
                                            <div class="sidebar__posts__image">
                                                <img src="{{ $related->image ? asset('storage/' . $related->image) : asset('assets/images/defaults/talktime-default.jpg') }}" width="90" height="60" alt="{{ $related->title }}">
                                            </div>
