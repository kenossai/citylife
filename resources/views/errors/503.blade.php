        ...
        <div class="container">
            <div class="error-404__content">
                <div class="error-404__content__top">
                    ...
                    <h2 class="error-404__title error-404__title--three">3</h2>
                </div><!-- /.error-404__content__top -->
                <h3 class="sec-title__title error-404__sub-title wow fadeInUp animated" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-name: fadeInUp;">Maintenance Mode</h3><!-- /.error-404__sub-title -->
                ...
                <a href="{{ route('home') }}" class="citylife-btn wow fadeInUp animated" data-wow-duration="1500ms" data-wow-delay="100ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 100ms; animation-name: fadeInUp;">
                    ...
                    <span class="citylife-btn__text">try again</span>
                </a>
