(function ($) {
    ...
    $(".gift-card__btn, .donate-page__form__amount__btn--amount").on(
        "click",
        function () {
            $(
                ".gift-card__btn,.donate-page__form__amount__btn--amount"
            ).removeClass("active");
            $(this).addClass("active");
            var amount = $(this)
                .find(
                    ".gift-card__btn__text, .donate-page__form__amount__btn__text"
                )
                .text();
    ...
    if ($(".custom-cursor").length) {
        ...
        // Only add event listeners if cursor elements exist
        if (cursor && cursorinner) {
            ...
            // Only add hover effects if cursor elements exist
            a.forEach((item) => {
    ...
    $(document).on("click", ".megamenu-clickable--close", function (e) {
        ...
        $(".megamenu-clickable--active").removeClass(
            "megamenu-clickable--active"
        );
        e.preventDefault();
    });
    ...
    function handleScrollbar() {
        ...
        $(".scroll-to-top .scroll-to-top__inner").css(
            "width",
            percentage + "%"
        );
    }
